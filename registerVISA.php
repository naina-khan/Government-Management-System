      ...
      <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="countryVisiting" id="countryVisiting" aria-describedby="emailHelp" placeholder="e.g. India">
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Reason For Visitng</label>
                    <input type="text" class="form-control" id="reasonVisiting" name="reasonVisiting" aria-describedby="emailHelp" placeholder="e.g. Studies, Family, Visit">
                </div>
