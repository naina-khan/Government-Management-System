...
if($_SERVER['REQUEST_METHOD'] =="POST")
{
    ...
    $passportNo= $_POST['registerPassNo'];
    ...
    $sql = "SELECT * FROM passport WHERE passportNo = '$passportNo'";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        $showError = "passportAlreadyExists";
    }
    else
    {
        
            // insert user details into database
        $sql = "INSERT INTO `passport` (`passportNo`, `emailID`, `firstName`, `lastName`, `address`) VALUES ('$passportNo','$email','$firstName','$lastName','$address')";
        $result =  mysqli_query($conn, $sql);
       
                // registration was successful
            header("Location: /php_program/index.php?registersuccess=true");
            exit();
    ...
    header("Location: /php_program/index.php?registersuccess=false&error=". $showError ."");
