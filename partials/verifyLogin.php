        ...
        if($result)
        {
            ...
            if(password_verify($pass, $row['password']))
            {
                ...
                $_SESSION['useremail'] = $email;
                  ...
                  header("Location: /php_program/index.php?loginsuccess=true");    
                    exit();
            }
            else 
            {
                ...
                header("Location: /php_program/index.php?loginsuccess=false&here");
                exit();
            }


        }
        header("Location: /php_program/index.php?loginsuccess=false");
        exit();
