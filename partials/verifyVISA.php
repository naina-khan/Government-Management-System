...
if($_SERVER['REQUEST_METHOD'] =="POST")
{
    ...
    $sql = "SELECT * FROM VISA WHERE visaNo = '$visanumber'";
    ...
    else
    {
        ...
        $sql = "INSERT INTO `VISA` (`visaNo`, `emailID`, `firstName`, `lastName`, `Phone`, `country`, `reason`) VALUES ('$visanumber','$email','$firstName','$lastName','$mobile','$country','$reason')";
        $result =  mysqli_query($conn, $sql);
