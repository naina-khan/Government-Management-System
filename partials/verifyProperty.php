...
if($_SERVER['REQUEST_METHOD'] =="POST")
{
    ...
    else
    {
        ...
        $sql = "INSERT INTO `property` (`propertyID`, `emailID`, `ownerfirstName`, `ownerlastName`, `mobNo`, `area`, `address`) VALUES ('$propertyID','$email','$firstName','$lastName','$mobile','$area','$address')";
        $result =  mysqli_query($conn, $sql);
