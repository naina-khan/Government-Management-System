...
if($_SERVER['REQUEST_METHOD'] =="POST")
{
    ...
    $sql = "SELECT * FROM govWork WHERE employeeID = '$employeeID'";
    ...
    else
    {
        ...
        $sql = "INSERT INTO `govWork` (`employeeID`, `emailID`, `firstName`, `lastName`, `job`) VALUES ('$employeeID','$email','$firstName','$lastName','$job')";
        $result =  mysqli_query($conn, $sql);
