...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $sql = "SELECT *   
        FROM users  
        INNER JOIN citizen ON users.emailID = citizen.emailID
        INNER JOIN passport ON users.emailID = passport.emailID
        INNER JOIN aadhar ON users.emailID = aadhar.emailID
        INNER JOIN army ON users.emailID = army.emailID
        INNER JOIN visa ON users.emailID = visa.emailID
        INNER JOIN pan ON users.emailID = pan.emailID
        INNER JOIN govwork ON users.emailID = govwork.emailID
        INNER JOIN dmv ON users.emailID = dmv.emailID
        INNER JOIN property ON users.emailID = property.emailID
        AND users.emailID = '$email'";
