      ...
      <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="registerMobile" name="registerMobile" aria-describedby="emailHelp" placeholder="e.g. 8603******">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="address" aria-describedby="emailHelp" placeholder="e.g. Shahbadpur">
                </div>
